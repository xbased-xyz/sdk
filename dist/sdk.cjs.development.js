...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[exports.ChainId.SEPOLIA] = "0xDaD39353Cb8A16CDbC70c01234Bf2CFbcD644F3a", _FACTORY_ADDRESS[exports.ChainId.BASE] = "0xC3550497E591Ac6ed7a7E03ffC711CfB7412E57F", _FACTORY_ADDRESS);
var INIT_CODE_HASH = '0xeaffb02e0852e2391eea302a843b596991773e7df7182de2a2404f263c6e4b10';
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.SEPOLIA] = /*#__PURE__*/new Token(exports.ChainId.SEPOLIA, '0xC53341A203ADFD60174A534CAc03141237Cdf92a', 18, 'WETH', 'Wrapped Ether'), _WETH[exports.ChainId.BASE] = /*#__PURE__*/new Token(exports.ChainId.BASE, '0x4200000000000000000000000000000000000006', 18, 'WETH', 'Wrapped Ether'), _WETH);
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchTokenData = function fetchTokenData(chainId, address, provider, symbol, name) {
    try {
      ...
      var _temp = typeof ((_TOKEN_DECIMALS_CACHE = TOKEN_DECIMALS_CACHE) === null || _TOKEN_DECIMALS_CACHE === void 0 ? void 0 : (_TOKEN_DECIMALS_CACHE2 = _TOKEN_DECIMALS_CACHE[chainId]) === null || _TOKEN_DECIMALS_CACHE2 === void 0 ? void 0 : _TOKEN_DECIMALS_CACHE2[address]) === 'number';
